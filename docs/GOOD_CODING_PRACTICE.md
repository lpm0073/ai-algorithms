...
- [Automated Pull Requests](https://github.com/lpm0073/ai-algorithms/pulls?q=is%3Apr+is%3Aclosed): Github Actions are triggered on pull requests to run any of several different kinds of technology-specific unit tests depending on the contents of the commits included in the PR.
...
- [GitHub Secrets](https://github.com/lpm0073/ai-algorithms/settings/secrets/actions) to provide sensitive data to Github Actions workflows
